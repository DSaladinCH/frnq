...
{
    public async Task<ApiResponse<List<ExternalLinkViewDto>>> GetLinks()
        => await GetAsync<List<ExternalLinkViewDto>>("api/AuthExternalLinks");

    public async Task<ApiResponse<object>> InitiateLink(string providerId)
...
{
    public async Task<ApiResponse<List<OidcProviderDto>>> GetProviders()
        => await GetAsync<List<OidcProviderDto>>("api/AuthOidc/providers");

    public async Task<ApiResponse<object>> InitiateLogin(string providerId)
